...
import { createFuncionario } from '@/lib/api-actions'
...
export default function AdminCadastroPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Cadastro feito somente pela API Express.
      ...
      console.error('[AdminCadastroPage] Erro ao cadastrar funcionário:', error)
      toast.error(
