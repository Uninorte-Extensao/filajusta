...
const codigoGerado =
  json.dados?.codigo ||
  json.dados?.consulta?.codigo ||
  ""

const cpfPaciente = booking.cpf!.replace(/\D/g, "")

// Salva código + CPF para a tela de sucesso/consulta
localStorage.setItem(
  "filajusta_last_booking",
  JSON.stringify({
    codigo: codigoGerado,
    cpf: cpfPaciente,
  })
...
router.push(`/sucesso?codigo=${encodeURIComponent(codigoGerado)}`)
    } catch (err) {
